"""Tests for indexing_tests_v6_s8 v6."""
import numpy as np
import pytest
import torch


class TestIndexingTestsV6S8Init:
    def test_default_configuration(self):
        config = {"module": "indexing_tests_v6_s8", "version": 6, "batch_size": 192}
...
class TestIndexingTestsV6S8Processing:
...
class TestIndexingTestsV6S8EdgeCases:
