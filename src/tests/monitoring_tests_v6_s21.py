"""Tests for monitoring_tests_v6_s21 v6."""
import numpy as np
import pytest
import torch


class TestMonitoringTestsV6S21Init:
    def test_default_configuration(self):
        config = {"module": "monitoring_tests_v6_s21", "version": 6, "batch_size": 192}
...
class TestMonitoringTestsV6S21Processing:
...
class TestMonitoringTestsV6S21EdgeCases:
