...
class DdpV525(nn.Module):
    """Neural network module for ddp_v525 v2.
    ...
    def __init__(self, config: Optional[DdpV525Config] = None):
        super().__init__()
        self.config = config or DdpV525Config()
        c = self.config
        ...
        logger.info("Initialized DdpV525 v2 with %d params",
