...
class DdpV540(nn.Module):
    """Neural network module for ddp_v540 v2.
    ...
    def __init__(self, config: Optional[DdpV540Config] = None):
        super().__init__()
        self.config = config or DdpV540Config()
        c = self.config
        ...
        logger.info("Initialized DdpV540 v2 with %d params",
