...
class DdpV510(nn.Module):
    """Neural network module for ddp_v510 v2.
    ...
    def __init__(self, config: Optional[DdpV510Config] = None):
        super().__init__()
        self.config = config or DdpV510Config()
        c = self.config
        ...
        logger.info("Initialized DdpV510 v2 with %d params",
