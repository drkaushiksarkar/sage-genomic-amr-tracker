# Sage Genomic Amr Tracker

![Python](https://img.shields.io/badge/Python-3.11+-blue) ![License](https://img.shields.io/badge/License-MIT-yellow)

Graph neural network for antimicrobial resistance tracking using CARD AMR genomes (271K), WHO GLASS surveillance, and transformer-based sequence classification
